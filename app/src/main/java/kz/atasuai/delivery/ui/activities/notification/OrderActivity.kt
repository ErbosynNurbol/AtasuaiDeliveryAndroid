        ...
        setContent {
            ...
            AtasuaiTheme(darkTheme = darkTheme) {
                AtasuaiScreen(
                    ...
                    OrderComponent(viewModel,currentLanguage,context,modifier = screenModifier)
                }
            }
        }
    }
...
@Composable
fun OrderComponent(viewModel: NotificationViewModel,currentLanguage: LanguageModel, context: Context, modifier: Modifier = Modifier,){
    Column(modifier = modifier.fillMaxSize()
        ...
        Column(modifier=Modifier.fillMaxWidth()
            ...
            Box(modifier=Modifier.fillMaxWidth()
                ...
                Row(
                    ...
                    VSpacerWi(10f)
                    Text(
                        text = T("ls_Orders2",currentLanguage),
        ...
        Column(modifier=Modifier.weight(1f).fillMaxWidth()
            ...
            EmptyNotification(currentLanguage,modifier=Modifier.fillMaxWidth(),NotifiType.Order)
        }
    }
}

@Composable
fun EmptyNotification(currentLanguage: LanguageModel,modifier:Modifier,type: NotifiType){
    Column(modifier = modifier.fillMaxSize()
        .background(AtasuaiTheme.colors.background)
        ,
        ...
        val painter = when(type){
            NotifiType.Order -> painterResource(id = R.drawable.notifi_order_empty)
            NotifiType.Income -> painterResource(id = R.drawable.notify_income_empty)
        }
        Image(
            painter = painter,
        ...
        VSpacerHi(35f)
        Text(
            text = "Әзірге хабарлама жоқ",
            style = AtasuaiTheme.typography.EmptyTitleStyle
        )
        VSpacerHi(16f)
        Text(
            text = "Кейін тапсырыстар бойынша хабарламалар осында пайда болады",
